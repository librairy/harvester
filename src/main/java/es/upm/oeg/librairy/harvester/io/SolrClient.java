...
public class SolrClient {
    ...
    public boolean save(Document doc){
        ...
        try {
            ...
            if (!doc.getLabels().isEmpty()) document.addField("labels_t",doc.getLabels().stream().map(r -> r.trim().replace(" ","_")).collect(Collectors.joining(" ")));
