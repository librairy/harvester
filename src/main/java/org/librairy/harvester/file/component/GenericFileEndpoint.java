 ...
 */
package org.librairy.harvester.file.component;
...
public abstract class GenericFileEndpoint<T> extends ScheduledPollEndpoint implements BrowsableEndpoint {
    ...
    protected static final String DEFAULT_STRATEGYFACTORY_CLASS = "org.librairy.harvester.file.component.strategy.GenericFileProcessStrategyFactory";
    ...
    /**
     * Pluggable filter as a org.librairy.harvester.file.component.GenericFileFilter class.
    ...
    /**
     * Pluggable sorter as a java.util.Comparator<org.librairy.harvester.file.component.GenericFile> class.
     */
    ...
    /**
     * Pluggable read-lock as a org.librairy.harvester.file.component.GenericFileExclusiveReadLockStrategy implementation.
     */
    ...
    /**
     * A pluggable org.librairy.harvester.file.component.GenericFileProcessStrategy allowing you to implement your own readLock option or similar.
