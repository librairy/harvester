...
public abstract class GenericFileEndpoint<T> extends ScheduledPollEndpoint implements BrowsableEndpoint {
    ...
    protected static final String DEFAULT_STRATEGYFACTORY_CLASS = "GenericFileProcessStrategyFactory";
    ...
    /**
     * Pluggable filter as a GenericFileFilter class.
    ...
    /**
     * Pluggable sorter as a java.util.Comparator<GenericFile> class.
     */
    ...
    /**
     * Pluggable read-lock as a GenericFileExclusiveReadLockStrategy implementation.
     */
    ...
    /**
     * A pluggable GenericFileProcessStrategy allowing you to implement your own readLock option or similar.
