package org.librairy.harvester.routes.oaipmh;
...
@TestPropertySource(properties = { "librairy.eventbus.uri = localhost", "librairy.hoarder.storage.path = ../hoarder/target/storage", "librairy.harvester.folder.input = target/workspace", "librairy.upf.miner.config = src/test/resources/DRIconfig.properties" })
